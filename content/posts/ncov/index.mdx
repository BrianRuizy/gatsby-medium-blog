...
This function will now return an HTTP response. When requested by the front-end, it will return the data frame used by Plotly to create the visualization.
